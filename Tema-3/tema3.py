...
for iteration in range(nr_iterations):
    for train_number in range(len(train_set[0])):
        ...
        layer_weights[0] -= numpy.dot(train_input, numpy.transpose(layer_errors_reshaped_1)) * learning_rate
        layer_weights[1] -= numpy.dot(activation_layer_results_reshaped_1, numpy.transpose(layer_errors_reshaped_2)) * learning_rate
